...
Here are some things we didn't get to, but would be cool to add:
...
- [ ] **More Features**: Add "Genre" or "Tag" features if we can find external metadata for the movies.

## Risky / Skipped Items
- **Full Dataset Training**: We currently sample 5M rows to save RAM. Training on the full 100M ratings requires a cluster or a beefy machine (32GB+ RAM).
